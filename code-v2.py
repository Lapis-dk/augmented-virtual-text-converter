...
def getContours(img):
    # print(cv2.findContours(img, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE))
    # print(len(cv2.findContours(img, cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_NONE)))
...
while cap.isOpened():
    ...
    if success:
        ...
        cv2.imshow("Result of mini-proj-1", imgResult)
